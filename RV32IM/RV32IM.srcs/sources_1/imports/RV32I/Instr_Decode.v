...
7'b0010011:  // Arithmetic Immediate Instructions
      begin
       {MemWrite,Branch,RegWrite,Jump,ImmSrc,AluSrcA,AluSrcB,ResultSrc} = 12'b0010_000_0_01_00;
...
default:
begin
{MemWrite,Branch,RegWrite,Jump,ImmSrc,AluSrcA,AluSrcB,ResultSrc} = 12'b0000_000_0_00_00;
alu_control = 5'bxxxxx;
end
