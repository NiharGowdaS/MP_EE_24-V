...
reg       Exception, Underflow, Overflow;
...
//through 2nd port of ALU we can pass the values ImmExtE, 
    ...
    Registers REG(clk,reset, ResultW, Rs1D, Rs2D, RdW, RegWriteW, RD1D, RD2D);
    
    Extend ext(InstrD[31:0], ImmSrcD, ImmExtD);
    
    mux3 resultmux( ALUResultW, ByteData, PCPlus4W, ResultSrcW, ResultW);
//if opcode=lw opcode&(f3==010)


assign ByteData = ({InstrF[14:12],InstrF[6:0]} == 10'b000_0000011) ? ({{24{ReadDataW[7]}},ReadDataW[7:0]}):ReadDataW;
