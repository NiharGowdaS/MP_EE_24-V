...
initial 
	begin
		// Instruction: 00450513 addi
		RAM[0] = 8'h13;
		RAM[1] = 8'h05;
		RAM[2] = 8'h65;
		RAM[3] = 8'h00;

		// Instruction: 00100593 addi
		RAM[4] = 8'h93;
		RAM[5] = 8'h05;
		RAM[6] = 8'h10;
		RAM[7] = 8'h00;
		// Instruction: 00100113 addi
		RAM[8] = 8'h13;
		RAM[9] = 8'h01;
		RAM[10] = 8'h10;
		RAM[11] = 8'h00;
		
		// Instruction: 00050863 beq
		RAM[12] = 8'h63;
		RAM[13] = 8'h08;
		RAM[14] = 8'h05;
		RAM[15] = 8'h00;
		
		// Instruction: 02a585b3 mul
		RAM[16] = 8'hb3;
		RAM[17] = 8'h85;
		RAM[18] = 8'ha5;
		RAM[19] = 8'h02;
		
		// Instruction:  40250533 sub
		RAM[20] = 8'h33;
		RAM[21] = 8'h05;
		RAM[22] = 8'h25;
		RAM[23] = 8'h40;
		
		// Instruction: ff5ff06f  00c0006fjal
		RAM[24] = 8'h6f;
		RAM[25] = 8'h00;
		RAM[26] = 8'hc0;
		RAM[27] = 8'h00;	
